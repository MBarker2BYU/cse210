...
// ***********************************************************************
// <copyright file="Pray.cs" company="EternalQuest">
...
public class Pray : ActionBase
{
    ...
    {
        Console.WriteLine();
        Console.WriteLine($"You kneel in prayer and feel peace. Gained {_LastAwardedFaithPoints} Faith Points.");
    }
