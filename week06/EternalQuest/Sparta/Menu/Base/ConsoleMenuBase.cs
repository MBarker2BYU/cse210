...
// ***********************************************************************
// <copyright file="ConsoleMenuBase.cs" company="EternalQuest">
//     Copyright (c) Spartan Systems. All rights reserved.
// </copyright>
// <summary></summary>
// ***********************************************************************

using EternalQuest.Sparta.ExtensionMethods;
using EternalQuest.Sparta.Interfaces;
using EternalQuest.Sparta.Menu.EventArgs;

namespace EternalQuest.Sparta.Menu.Base;
        ...
        try
        {
            ...
            while (true)
            {
                ...
                if (m_MenuItems != null)
                {
                    ...
                    {
                        var description =m_MenuItems[index].GetDescription();

                        if (string.IsNullOrWhiteSpace(description))
                            description = m_MenuItems[index].ToString().InsertSpaces();
                        
                        WriteLine(description, currentIndex == index);
                    }
                }
