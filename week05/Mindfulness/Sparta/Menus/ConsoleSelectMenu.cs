...
// ***********************************************************************
// <copyright file="ConsoleSelectMenu.cs" company="Mindfulness">
...
/// Implements the <see cref="IConsoleSelectMenu" />
/// </summary>
/// <param name="backgroundColor">Color of the background.</param>
/// <param name="foregroundColor">Color of the foreground.</param>
/// <seealso cref="IConsoleSelectMenu" />
public class ConsoleSelectMenu(ConsoleColor backgroundColor = ConsoleColor.White, ConsoleColor foregroundColor = ConsoleColor.Black) : IConsoleSelectMenu
{
    #region Implementation of IConsoleMenuBase
    ...
    /// <summary>
    /// Called when [menu item selected event].
    /// </summary>
    /// <param name="menuItem">The menu item.</param>
    private void OnMenuItemSelectedEvent(IStringMenuItem menuItem)
        => MenuItemSelectedEvent?.Invoke(this, new MenuItemSelectedEventArgs(menuItem));
        ...
        try
        {
            ...
            while (true)
            {
                ...
                if (m_MenuItems != null)
                {
                    ...
                    {
                        WriteLine(m_MenuItems[index].MenuText.InsertSpaces(), currentIndex == index);
                    }
                }
                ...
                switch (consoleKeyInfo.Key)
                {
                    ...
                    case ConsoleKey.Enter:
                        OnMenuItemSelectedEvent(m_MenuItems[currentIndex]);
                        break;
                }
            }
    ...
    private IStringMenuItem[] m_MenuItems { get; set; }
